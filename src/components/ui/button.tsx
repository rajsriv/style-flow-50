  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body",
  {
    variants: {
      variant: {
        ...
        coral: "bg-coral text-primary-foreground hover:opacity-90 hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-coral/20",
        glass: "backdrop-blur-xl bg-card/60 border border-border/50 text-foreground hover:bg-card/80",
        magnetic: "bg-card border border-border text-foreground transition-all duration-500 ease-out hover:translate-y-[-4px] hover:scale-[1.02] hover:shadow-[0_20px_40px_-12px_hsl(var(--primary)/0.3)]",
      },
      size: {
